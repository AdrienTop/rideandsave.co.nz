...
// Official figures: NZTA Motor Vehicle Register full fleet (FC_COMBINED, all years to 2026, ~5.9M records)
...
const VD = {
  ...
  medium:   { icon:'🚘', name:'Medium car',   sub:'Corolla · Mazda 3 · Golf',   fuels:['petrol'],           default:'petrol',  cons:{petrol:8.9},                maint:0.08,
              models:{petrol:['Toyota Corolla 2.0 (7.4)','Mazda 3 2.0 (7.7)','VW Golf 1.5T (8.2)','Hyundai i30 2.0 (8.7)','Honda Civic 1.5T (9.5)']}},

  small_suv:{ icon:'🚙', name:'Small SUV',    sub:'ASX · Seltos · Stonic',      fuels:['petrol'],           default:'petrol',  cons:{petrol:8.5},                maint:0.09,
